...
using Signet.Api.Domain.Exceptions;
...
public sealed class SchemaVersion : ValueObject
{
    ...
    public static ValueTask<SchemaVersion> CreateVersionAsync(string version)
    {
        ...
        return CreateVersionAsync(major, minor, patch);
    }

    public static async ValueTask<SchemaVersion> CreateVersionAsync(int major = 1, int minor = 0, int patch = 0)
    {
        ...
        await newVersion.CheckInvariantsAsync();
    ...
    protected override ValueTask CheckInvariantsAsync()
    {
