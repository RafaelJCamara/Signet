...
public static class SubjectEndpoints
{
    ...
    public static IEndpointRouteBuilder MapSubjectEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/", ListSubjects).WithSummary("List subjects in an environment");
        group.MapGet("/{subject}", GetSubject).WithSummary("Get a subject and its versions");

        group.MapGet("/{subject}/versions", ListVersions).WithSummary("List versions");
